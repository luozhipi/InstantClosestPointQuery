...
float Preview3D::DEFAULT_LIGHT_DIRECTION[] = {0.04,0.16,-0.99};
...
Preview3D::Preview3D(int start_time)
{
	...
	TwDefine(" TweakBar size='280 400' text=light alpha=255 color='40 40 40' position='3 200' valueswidth=100 visible=true "); // change default tweak bar size and color
